...
function onAlbumClick(album: { name: string, artist: string, cover: string | null, preview: string | null }) {
...
function showLoginButton(show: boolean) {
  let btn = document.getElementById('spotify-btn') as HTMLButtonElement;
  if (!btn) {
